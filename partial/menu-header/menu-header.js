angular.module('stripeMenu').controller('MenuHeaderCtrl', MenuHeaderCtrl);

function MenuHeaderCtrl($scope, $timeout, menuDataService, $log){
    ...
    function activate(){
        ...
        self.menuHeaders = [];
        self.initMenu = initMenu;
        self.getDropDown = getDropDown;
        ...
        $timeout(function(){
            menuDataService.
                ...
                then(function(response){
                    ...
                    self.menuHeaders = Object.keys(self.menuData);
                }).catch(function(err){
                    $log.error(err);
                });
        });
    ...
    function getSubmenu(menu){
        return self.menuData[menu];
    }

    function initMenu(isLast){
        if(isLast){
            initMenuContext();
        }
    }
    ...
    function getDropDown(menu){
        var lastChar = menu.charAt(menu.length - 1);

        if(menu === 'company'){
            return menu;
        }

        return lastChar === 's' ? menu : menu + 's';
    }
    ...
    function initMenuContext(){
        ...
        function globalNavDropdowns(e) {
            ...
            document.body.addEventListener(n.end, function(e) {
                return Strut.touch.isDragging || t.closeDropdown();
            });
        }
        ...
        function globalNavPopup(e) {
            ...
            document.body.addEventListener(n, function(e) {
                return (Strut.touch.isDragging || t.closeAllPopups());
            }, !1);
        ...
        (function() {
            ...
            // var t = "data-action-source";
            // var n = "data-analytics-modal";
            // var r = "data-modal-source";
        ...
        var Strut = {
            ...
            ready: function(e) {
                return (document.readyState !== "loading" ? e() : document.addEventListener("DOMContentLoaded", e));
            }
        };
        ...
        globalNavDropdowns.prototype.checkCollision = function() {
            ...
            if (e.compact === 1) {
                ...
                return (n.left + n.width / 2 > t / 2 && (e.container.classList.remove("compact"), e.compact = !1));
            } else {
                var r = e.primaryNavItem ? e.primaryNavItem.getBoundingClientRect() : null,
                    i = e.secondaryNavItem.getBoundingClientRect();
                return (r && r.right > i.left && (e.container.classList.add("compact"), e.compact = !0));
            }
        };
        ...
        globalNavDropdowns.prototype.openDropdown = function(e) {
            ...
            this.dropdownSections.forEach(function(e) {
                ...
                return (e.name === n ? (e.el.classList.add("active"), r = "right", i = e.content.offsetWidth, s = e.content.offsetHeight, o = e.content) : e.el.classList.add(r));
            });
        ...
        globalNavDropdowns.prototype.toggleDropdown = function(e) {
            return (this.activeDropdown === e ? this.closeDropdown() : this.openDropdown(e));
        }; 
        ...
        globalNavPopup.prototype.togglePopup = function() {
            ...
            return (this.closeAllPopups(!0), e || this.root.classList.add(this.activeClass));
        }; 
        ...
        if(Strut.supports.pointerEvents || Strut.load.css("v3/shared/navigation_ie10.css")){
